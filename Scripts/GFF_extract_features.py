...
def main():
	...
	parser.add_option("-g", "--genome", dest="genome",
					help="Genome seqeunce in FASTA format", metavar="genome.fasta [Required]")
	...
	genes , mRNA = read_gff_from_file(options.gff)
	### genes structure:
	### genes[gene_id] = {}
	...
	if options.temp :
		...
		write_gff3( genes , tmp_gff3 , reference )
	...
	if options.print_gff3 :
		write_gff3( genes, options.prefix+".gff3" , reference)
